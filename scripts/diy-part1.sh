...
# 解决编译U-BOOT失败
wget -qO- https://github.com/coolsnowwolf/lede/files/14896014/318-revert-Use-importlib-to-find-the-help.patch /package/boot/uboot-rockchip/patches/318-revert-Use-importlib-to-find-the-help.patch
